            ...
            <div class="container">
                ...
                <div class="card-body border rounded-4 shadow p-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control shadow-sm" name="namadata" placeholder="Isikan Nama Anda">
                    </div>
                    <div class="mb-3">
                        <label for="hadiran" class="form-label" id="labelhadir">Kehadiran</label>
                        <select class="form-select shadow-sm" aria-label="selectkehadiran" name="haridan">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control shadow-sm" name="textdata" rows="4" placeholder="Tulis Ucapan & Doa"></textarea>
                    </div>
                    <div class="d-grid mb-2">
                        <button class="btn btn-primary btn-sm rounded-4 shadow" type="submit" id="kirim">
